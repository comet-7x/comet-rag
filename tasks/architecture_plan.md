...
> 当前唯一 P0：完成 M2-T5 容错、deadline 与资源上限
> 最后更新：2026-09-09
...
1. **M2-T5**：为已完成的 MinerU 主路径补总 deadline、请求超时、错误分类、404
   单次重提、响应/Markdown 限长及取消清理。当前轮询主路径尚无总 deadline，
   在完成 T5 前不得接入组合根。
2. **M2-T6**：配置、独立 MinerU 闸门、组合根注册与逆序关闭。只有 T5 契约全绿
   才能启用。
