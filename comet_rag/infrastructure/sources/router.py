...
from comet_rag.ports.source import LoadedResource, SourceContent, SourceLoaderPort
...
class LoaderRoute:
    ...
    Matchers keep routing open to new adapters without extending a closed
    source-type enum.
    """
...
class AutoLoader(BaseLoader):
    ...
    def default_routes(
        ...
        from comet_rag.infrastructure.sources.http import (  # noqa: PLC0415
            DEFAULT_MAX_DOWNLOAD_BYTES,
            URLLoader,
        )
        from comet_rag.infrastructure.sources.local import LocalLoader  # noqa: PLC0415
